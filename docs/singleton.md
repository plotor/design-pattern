- [一. 单例模式](#一-单例模式)
    - [1.1 单例模式解决的问题](#11-单例模式解决的问题)
    - [1.2 三大类单例模式的实现及其优缺点](#12-三大类单例模式的实现及其优缺点)
        - [1.2.1 饿汉式](#121-饿汉式)
        - [1.2.2 饿汉式：基于枚举](#122-饿汉式基于枚举)
        - [1.2.3 懒汉式](#123-懒汉式)
        - [1.2.4 懒汉式：双重检查加锁](#124-懒汉式双重检查加锁)
        - [1.2.5 登记式](#125-登记式)
        - [1.2.6 登记式：基于静态内部类](#126-登记式基于静态内部类)
- [二. 多例模式](#二-多例模式)
    - [2.1 多例模式解决的问题](#21-多例模式解决的问题)
    - [2.2 有上限多例和无上限多例](#22-有上限多例和无上限多例)
        - [2.2.1 有上限多例](#221-有上限多例)
        - [2.2.2 无上限多例](#222-无上限多例)
